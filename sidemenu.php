...
<html lang="ja">
    ...
    <body>
        <div id="sidemenu" style="background-color: #222;">
            <div class="logo" style="margin: 5% 5% 5% 5%; border: solid 2px #222; background-color: #b22222; vertical-align: middle;">
                <p style="font-size: 25px; color: white;">connexy</p>
            </div>
            
            <div id="side_menubar" style="margin-top: 10px;">
                <div style="margin-left: 5%; marin-right: 5%; margin-bottom: 5%; width: 90%; height: 180px; display: block; border: solid 2px; background-color: white;">
                    
                    <!-- 画像が選択されていない時 -->
                    <?php if($upflimage == ""): ?>
                        <div style="margin-top: 15px; margin-left: 15px; margin-right: 15px; height: 120px; border: solid 1px;">
